...
// MCPHandler handles MCP asset installation for Kiro (both packaged and config-only)
...
// Install installs an MCP asset to Kiro by updating mcp.json.
...
// Remove removes an MCP entry from Kiro
